...
const { config: { outputFolder, selectedQueries, queryFile, queryFilePath, withMutations }, args } = require(path.join(path.resolve(), C.ARTILLERY_CONFIG))
...
const reportPath = path.join(path.resolve(), '..', outputFolder)
